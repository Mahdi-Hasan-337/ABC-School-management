...
//					String query = "DELETE FROM `student_register` WHERE id='" + ID + "'";//String query="UPDATE studentinfo SET Name=' "+s2+" ' WHERE id="+id;
//					String query = "UPDATE studentinfo SET id='" + ID + "'";

					String query =  "UPDATE `student_register` SET `Name`='" + Name + "',`Class`='" + Cls + "',`GPA`='" + gpa + "',`Grade`='" + grade + "' WHERE ID ='" + ID + "'";
					st.executeUpdate(query);
